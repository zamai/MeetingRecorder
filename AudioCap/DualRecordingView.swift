...
struct DualRecordingView: View {
    ...
    private func createRecorders() {
        ...
        let sampleRate = newMicRecorder.audioEngine.inputNode.inputFormat(forBus: 0).sampleRate
        ...
        let newSystemRecorder = ProcessTapRecorder(fileURL: systemAudioFileURL, tap: tap, sampleRate: sampleRate)
